export const sdb = {
    ...
    metadata: {
        ...
        '231': {
            ...
            critical: false,
            description:
                'Indicates the approximate SSD life left, in terms of program/erase cycles or available reserved blocks. A normalized value of 100 represents a new drive, with a threshold value at 10 indicating a need for replacement. A value of 0 may mean that the drive is operating in read-only mode to allow data recovery.',
            display_type: 'normalized',
        },
        '232': {
