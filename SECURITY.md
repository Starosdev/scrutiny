...
2. **Authentication**: Scrutiny supports opt-in API authentication with token-based and password-based login. See [Authentication Guide](docs/AUTH.md) for setup instructions
