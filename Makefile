...
.PHONY: binary-all
binary-all: binary-collector binary-collector-zfs binary-collector-performance binary-collector-filesystem binary-web
	@echo "built binary-collector, binary-collector-zfs, binary-collector-performance, binary-collector-filesystem and binary-web targets"
